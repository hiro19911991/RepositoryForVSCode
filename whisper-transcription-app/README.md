...
- **話者分離（Diarization）**: pyannote/speaker-diarization による話者ラベル付き文字起こし
...
#### 話者分離（pyannote）を使う場合
1. Hugging Faceで以下2つのモデルページを開き、利用規約に同意  
   - https://huggingface.co/pyannote/speaker-diarization  
   - https://huggingface.co/pyannote/segmentation  
2. https://huggingface.co/settings/tokens でアクセストークンを作成
3. アプリのサイドバー「話者分離（pyannote）」でトークンを入力して有効化
